...
cobra-component-models could always use more documentation, whether as part of the
...
2. Clone your fork locally
   ...
   .. code-block:: console
       ...
       git clone git@github.com:your_name_here/cobra-component-models.git
